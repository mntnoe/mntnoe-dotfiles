...
function! s:Project(filename) " <<<
    ...
    if !exists("g:proj_running")
        ...
        " Mappings <<<
        " CUSTOMIZED! do not update
        nnoremap <buffer> <silent> <Return>   \|:call <SID>DoFoldOrOpenEntry('', 'e')<CR>
        nnoremap <buffer> <silent> <M-Return> \|:call <SID>DoFoldOrOpenEntry('', 'TabOpen')<CR>
        nnoremap <buffer> <silent> <LocalLeader>t \|:call <SID>DoFoldOrOpenEntry('', 'TabOpen')<CR>
        nnoremap <buffer> <silent> <LocalLeader>T \|:call <SID>DoFoldOrOpenEntry('', 'tabe')<CR>
        nnoremap <buffer> <silent> <LocalLeader>s \|:call <SID>DoFoldOrOpenEntry('', 'sp')<CR>
        ...
        nmap     <buffer> <silent> <RightMouse>   <LocalLeader><space>
        nmap     <buffer> <silent> <2-RightMouse> <LocalLeader><space>
        nmap     <buffer> <silent> <3-RightMouse> <LocalLeader><space>
        nmap     <buffer> <silent> <4-RightMouse> <LocalLeader><space>
        nnoremap <buffer> <silent> <LocalLeader><space>  \|:silent exec 'vertical resize '.(match(g:proj_flags, '\Ct')!=-1 && winwidth('.') > g:proj_window_width?(g:proj_window_width):(winwidth('.') + g:proj_window_increment))<CR>
