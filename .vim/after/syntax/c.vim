...
syn keyword Comment     debug_int trace trace_noln debug_int_verbose trace_verbose trace_noln_verbose

" CodeVision AVR
syn keyword Type        flash
syn keyword PreProc     asm endasm
syn keyword avrPort     PORTA PORTB PORTC PORTD PORTE
syn keyword avrPort     PINA PINB PINC PIND PINE
syn keyword avrPort     DDRA DDRB DDRC DDRD DDRE

hi def link avrPort Special
